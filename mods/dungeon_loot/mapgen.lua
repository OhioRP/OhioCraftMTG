...
local function populate_chest(pos, rand, dungeontype)
	...
	local item_list = DungeonLoot._internal_get_loot(pos.y, dungeontype)
	-- take random (partial) sample of all possible items
	local sample_n = math.min(#item_list, DungeonLoot.STACKS_PER_CHEST_MAX)
...
minetest.register_on_generated(function(minp, maxp, blockseed)
	...
	local num_chests = rand:next(DungeonLoot.CHESTS_MIN, DungeonLoot.CHESTS_MAX)
