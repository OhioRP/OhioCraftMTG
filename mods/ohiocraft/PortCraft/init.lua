...
dofile(pathjoin(minetest.get_modpath("portcraft"), "blocks", "woods.lua"))
dofile(pathjoin(minetest.get_modpath("portcraft"), "blocks", "barrel.lua"))
dofile(pathjoin(minetest.get_modpath("portcraft"), "blocks", "beacon.lua"))
